// C11Practice.cpp : Example features of modern C++
//
...
int main(int argc, char **argv)
{
    ...
    // determine (ie deduce) the type that is needed via context  For example
    ...
    // or how about this. Sure reduces typing
    ...
    // for say your Poly class you would need to add iterators and begin() and end()
    // to your class.  We wont do this at the moment.  Maybe later.
