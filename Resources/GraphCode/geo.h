...
//x = r λ cos(φ0)
//y = r φ
//p.x = earthRadiusMi * cos(ll.lat) * cos(ll.lon);
//p.y = earthRadiusMi * cos(ll.lat) * sin(ll.lon);

//λ = longitude
//φ = latitude
//x = r λ cos(φ0)
//y = r φ
//p.x = earthRadiusMi * ll.lon * cos(deg2rad(ll.lat));
//p.y = earthRadiusMi * cos(deg2rad(ll.lat));

/**
* Turn a latitutude in the form [0 , 180] to the form [-90 , 90].
* @param {float} 	- lat (from 0,180)
* @return {float} 	- lat (from -90,90)
*/
...
* @param {float} 	- lat (from -90,90)
* @return {float} 	- lat (from 0,180)
*/
...
* @param {float} 	- lat (from -180,180)
* @return {float} 	- lat (from 0,360)
*/
